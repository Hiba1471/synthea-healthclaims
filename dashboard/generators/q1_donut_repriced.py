#!/usr/bin/env python3
"""Generate dashboard/q1_donut_repriced.html -- the PRICE-CORRECTED donut,
from sql/results/q1_condition_breakdown_repriced_2020_2024.csv.

    python3 dashboard/generators/q1_donut_repriced.py

Identical drawing logic to q1_donut.py, which stays untouched and remains the
correct picture of the real, as-billed database -- other files in this project
cite its numbers as ground truth, so do not edit it to "fix" it; edit this one.

Eleven conditions are divided down to a real-world benchmark, the other 174
left as billed (q1_condition_breakdown_repriced.sql). The corrected diagnosed
total is $22.9B against $72.7B as billed, and the top three change identity
completely: kidney disease, pregnancy, breast cancer, where as billed it was
pregnancy, allergy, gingivitis.
"""
import csv, math, os


ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
SRC  = os.path.join(ROOT, 'sql/results/q1_condition_breakdown_repriced_2020_2024.csv')
OUT  = os.path.join(ROOT, 'dashboard/q1_donut_repriced.html')
...
def build():
    ...
    o.append('<h1>Three conditions, two fifths of the money</h1>')
    o.append('<p class="sub">Share of $22.9&nbsp;billion in condition-attributable '
             'spend, 2020&ndash;2024. <strong>Price-corrected:</strong> eleven conditions '
             'repriced to a real-world benchmark, 174 others as billed.</p>')
    open_svg = ('<div class="figure"><svg viewBox="0 0 760 560" role="img" '
                'aria-label="Donut chart: three conditions account for 39 percent '
