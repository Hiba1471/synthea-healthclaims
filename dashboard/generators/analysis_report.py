...
def build():
    ...
    o = ['<title>Calder Health — Five-Year Claims Analysis</title>',
         ...
         '</style>',
         '<div class="wrap">', HEADER, ABOUT, NORTHSTAR, HOWTOREAD, SUMMARY, NOTANSWERED,
    ...
    for i, f in enumerate(FINDINGS, 1):
        ...
        o.append('<div class="prose"><p><strong>What this shows.</strong> %s</p>'
                 ...
                 % (f['shows'], f['why']))
        o.append('<div class="examined"><p class="exhd">What we examined</p><ul>%s</ul></div>'
...
<p class="mission"><strong>Our mission:</strong> keep comprehensive cover affordable for the
people we insure &mdash; and keep it affordable in the places they actually get care.</p>
<p>Calder is a non-profit health plan headquartered in Cleveland, serving <strong>1.26 million
members</strong> with concentrations in Chicago, Detroit and Northeast Ohio. We run two lines of
business, and they are designed differently:</p>
<ul>
<li><strong>Commercial</strong> &mdash; employer group plans, built on a deductible and
coinsurance with an annual out-of-pocket maximum.</li>
<li><strong>Government</strong> &mdash; Medicaid and Medicare managed care, built on a flat
copay per visit.</li>
</ul>
<p>That difference turns out to matter more than almost anything else in this report. The same
condition can cost a commercial member ten times what it costs a government member, and it is our
own benefit design doing it.</p>
<p><strong>The brief.</strong> Before we set benefits and negotiate networks for 2026, understand
three things: where the money went, who bore it, and where it concentrates.</p>'''

NORTHSTAR = '''<h2 class="sec">The three numbers we steer by</h2>
<div class="cards">
...
the number our mission lives or dies on.</div></div>
<div class="card"><div class="lbl">Spend concentration</div><div class="big">86 sites</div>
<div class="sub2">Of 3,918 facilities, 86 carry half of everything we spend. A list short enough
to work through by hand.</div></div>
</div>'''
...
conditions dominate, who pays what proportion, how few sites carry the spend &mdash; these hold
up and are the basis of everything below.</p>
<p><strong>Do not trust:</strong> absolute dollar amounts. A pregnancy bills
<strong>8.6&times; what it costs in reality</strong>. Do not quote a per-case figure from this
report to anyone.</p>
<p><strong>Cannot be answered here at all:</strong> anything about negotiated rates, denials,
bad debt or collections. In this data every claim is paid in full, and no provider is charged a
different price from any other. Those are properties of the simulation, not findings about us.</p>
</div>'''

SUMMARY = '''<h2 class="sec">Executive summary</h2>
<ul class="summary">
<li><strong>Twenty conditions carry 91% of the bill we can attribute to a diagnosis</strong>
&mdash; and pregnancy alone is 39.8% of it. Our spend is not spread thin; it sits in a handful of
places.</li>
...
same care, a ten-fold difference, and it is our design that creates it.</li>
...
<li><strong>Our most expensive hospitals are not charging more.</strong> Reprice every procedure
identically and the gap between sites barely moves &mdash; only 7.8% of a site&rsquo;s cost per
visit is its prices. They differ in what they treat, not what they charge.</li>
</ul>'''

NOTANSWERED = '''<h2 class="sec">What we could not answer</h2>
<p>Stated plainly so that silence is not mistaken for a clean bill of health.</p>
<ul>
<li><strong>Whether members skip preventive care.</strong> We checked. Wellness visits reach
1,259,199 of our 1,259,375 members, and the small variation that exists tracks who is in each
group rather than what they received. The data schedules these visits by protocol, so it cannot
show anyone declining or missing care. The answerable neighbour of this question is Finding 2.
(<code>q3_preventive_access.sql</code>)</li>
<li><strong>Whether any hospital is efficient.</strong> Every difference between sites resolves
to what they treat. Prices barely vary, and neither does the amount of work done for a given
condition.</li>
<li><strong>Anything about denials, collections or bad debt.</strong> Every claim in this data is
paid in full.</li>
<li><strong>Whether our members are sicker or healthier than the market.</strong> The population
is generated, not observed, and its very sickest members are under-represented compared with real
claims data.</li>
</ul>'''
...
FINDINGS = [
 {'title': 'Twenty conditions carry nearly all of the bill, and one of them is pregnancy',
  ...
  'shows': 'Of the $72.7B we can attach to a specific diagnosis, <strong>twenty conditions '
           'account for 90.8%</strong> &mdash; and 66.6% of everything we spend. Normal '
           ...
           'into 2,384.',
  'why': 'It tells us where to look and, just as usefully, where not to. A programme aimed at '
         'the long tail of conditions would be working on a third of our spend at most. It also '
 ...
 {'title': 'Members carry a fifth of the bill, and it falls hardest on the cheapest care',
  ...
  'why': 'This is our mission measured directly, and it reads badly. The care a member pays most '
         'for is the routine, inexpensive, easily-deferred kind &mdash; a check-up, a filling, a '
         'screening. The care we protect them from is the catastrophic kind they cannot defer '
 ...
 {'title': 'Which plan a member holds matters more than what is wrong with them',
  ...
  'why': 'This gap is ours. It is not the market, not the providers, not how sick anyone is '
         ...
         'government member pays their copay and nothing more. Any figure we quote as '
 ...
 {'title': 'Spending concentrates in places, not in people',
  ...
  'shows': '<strong>86 of our 3,918 facilities carry half of everything we spend</strong> &mdash; '
  ...
  'why': 'It settles where our attention is worth spending. 86 sites is a list a team can '
  ...
  'examined': [
    ...
    'How our member concentration compares with real claims data. Ours is flatter &mdash; our '
 ...
 {'title': 'Our most expensive hospitals are not charging more',
