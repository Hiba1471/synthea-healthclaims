...
def build():
    ...
    for r in rows:
        o.append('<circle class="pt {}" cx="{:.1f}" cy="{:.1f}" r="{:.1f}"><title>{}\n'
                 ...
                 .format(r['grp'], sx(r['price']), sy(r['visits']), r['r'],
...
proving it.</p>
<p class="note">731 sites with at least 1,000 patients, 2020&ndash;2024. Circle size is the number of
patients (1,002 to 48,964). Generated by
