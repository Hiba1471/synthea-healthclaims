#!/usr/bin/env python3
"""Generate dashboard/q2_who_bears_the_cost.html from
...
OUT  = os.path.join(ROOT, 'dashboard/q2_who_bears_the_cost.html')
...
TAKE = '''<div class="take"><strong>The burden is inverted against cost.</strong> The types of care where
patients carry the most are the cheap, routine ones &mdash; blood disorders at 38.9% of a $121M bill,
diabetes and metabolic care at 36.6% of $435M. The expensive ones are heavily insured: cancer sits
last at 8.3% of $7.1B. Dental is the one place a large share and real money meet &mdash; 27.9% of an
$11.83B bill, falling on 938,009 people.</div>'''
...
<li>Dollar amounts inflated by flat procedure pricing; rankings and ratios hold.</li>
<li>The 20.4% headline is the same measure over all $99.11B; the 27% excluded here carries 28.3%.</li>
</ul>
