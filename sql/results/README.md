...
| `q3_pregnancy_pathway_split_2020_2024.csv` | 2 | **Why the one variable condition is not a lever either.** Normal pregnancy is the only condition where hospitals differ much (0.962 against a typical 0.027) on $28.9B. Split by cost per claim: at the cheapest quarter **95.5% of women give birth there** and the birth is 29.7% of billing — delivery units. At the dearest quarter only **7.1%** give birth there and the birth is 0.1% — antenatal clinics seeing a woman ten times across nine months. Cost per claim compares one birth against nine months of check-ups. |
