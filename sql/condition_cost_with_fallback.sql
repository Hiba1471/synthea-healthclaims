...
claim_condition AS (
    ...
    LEFT JOIN ENERGY_PIPELINE.PUBLIC.CODE_DICTIONARY d1 ON c.DIAGNOSIS1 = d1.CODE
    LEFT JOIN ENERGY_PIPELINE.PUBLIC.CODE_DICTIONARY d2 ON c.DIAGNOSIS2 = d2.CODE
)
SELECT
